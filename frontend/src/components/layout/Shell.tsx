...
import { Library, LogIn, Building2, Menu, PanelRightOpen, Wand2, LayoutTemplate, Package, Hammer, Search, Compass, GitBranch, Layers, Sparkles } from 'lucide-react';
                    ...
                    <Sheet>
                        ...
                        <SheetContent side="left" className="p-0 w-64">
                            ...
                            <nav className="p-4 space-y-1">
                                ...
                                {shouldShow('feature_flow') && (
                                    <Link href="/app/flow" className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md ${pathname === '/app/flow' ? 'text-primary-500 bg-primary-500/10' : 'text-muted-foreground hover:bg-accent hover:text-foreground'}`}>
